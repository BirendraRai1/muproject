...
var Api = (function() {
  ...
  xhr.onreadystatechange = function() {
    ...
    success: function(data) {
      ...
      for(var i=0; i<=9; i++) {
        try{
         print=print+'<div class="carousel-item"><div class="card" style=""> <a href="'+data.data[0][i]['Url']+'" style="text-decoration:none; cursor:default "><img class="card-img" src="'+data.data[0][i]['bg']+'" alt=""><div class="card-img-overlay" style="background:rgba(0,0,0,0.4)" ><div class="top-left" style="position: absolute; color:#80cbc4 "><b>'+data.data[0][i]['category']+'</b></div><div class="top-right" style="float:right; color:#80cbc4">'+data.data[0][i]['duration']+'</div><div class="centered" style="position:absolute; top:50%; left:50%; transform: translate(-50%,-50%); color:white"><p style="text-align:center; margin:1px "><b>'+data.data[0][i]['name']+'</b></p><center><i class="fa fa-eye" aria-hidden="true" style="text-align:center;">200</i></center>&nbsp;&nbsp;<p><center style="margin-top:50px"><img src="https://scontent.fblr7-1.fna.fbcdn.net/v/t1.0-9/20257940_10207778470894762_8044157181682224722_n.jpg?oh=194eed1ef4166695149f14ab0782d0e5&oe=5ACB3B09" class="rounded-circle" alt="Cinque Terre"><br>'+data.data[0][i]['author']+'</p></center></div></div></div></div>'
        }
  ...
  function todaynews(i){
    $.ajax({
      url: 'https://valleyai.mybluemix.net/dst.php?cid='+i,
      type:"GET",
      async:true,
      dataType:"JSON",
      success:function(data){
